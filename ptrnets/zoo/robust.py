...
def resnet50_l2_eps0(
    ...
    **kwargs,
    ...
    """
    return _model(
        "resnet50_l2_eps0", resnet50, pretrained, progress, use_data_parallel, **kwargs
    )
...
def resnet50_l2_eps1(
    ...
    **kwargs,
    ...
    """
    return _model(
        "resnet50_l2_eps1", resnet50, pretrained, progress, use_data_parallel, **kwargs
    )
...
def resnet50_l2_eps3(
    ...
    **kwargs,
    ...
    """
    return _model(
        "resnet50_l2_eps3", resnet50, pretrained, progress, use_data_parallel, **kwargs
    )
...
def resnet50_l2_eps5(
    ...
    **kwargs,
    ...
    """
    return _model(
        "resnet50_l2_eps5", resnet50, pretrained, progress, use_data_parallel, **kwargs
    )
