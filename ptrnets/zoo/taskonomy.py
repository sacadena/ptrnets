...
encoders = [
    "_".join([task, "encoder"]) for task in LIST_OF_TASKS
]  # names of taskonomy encoder networks

__all__ = encoders


def _model(
    model_name: str, pretrained: bool, progress: bool, use_data_parallel: bool, **kwargs
):
